...
export default function ImageCropper({ imageSrc, onCropComplete, onCancel }: ImageCropperProps) {
  ...
  return (
    <div className="fixed inset-0 bg-black/80 flex items-center justify-center z-[60] p-2 sm:p-4 overflow-y-auto">
      <div className="bg-white rounded-2xl max-w-4xl w-full max-h-[90vh] overflow-hidden my-4 flex flex-col">
        {/* Header */}
        ...
        {/* Content */}
        <div className="p-4 overflow-y-auto flex-1 pb-20 md:pb-4">
        ...
        {/* Footer */}
        <div className="flex flex-col sm:flex-row justify-end gap-3 p-4 pb-20 md:pb-4 border-t border-gray-200 flex-shrink-0">
          <button
            onClick={onCancel}
