      ...
      <div className="card card-elevated w-full max-w-md space-y-8 animate-scale-in">
        ...
        <div className="space-y-3">
          ...
          <button
            ...
            className="btn w-full py-4 text-lg font-semibold group relative overflow-hidden bg-[#1877F2] hover:bg-[#166FE5] text-white border-0"
            disabled={loading}
          >
            <div className="flex items-center justify-center gap-3">
        ...
        <div className="text-center text-sm text-dark-400 space-y-2">
          <p>Quick and secure sign-in with your social account</p>
